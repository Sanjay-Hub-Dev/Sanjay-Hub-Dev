...
- 🐳 Learning Docker, CI/CD & scalable deployments
...
- **WanderLust** – Travel booking platform (MERN)
- **Stock Trading Platform** – Zerodha clone with analytics dashboard
- **Video Conferencing App** – WebRTC + Socket.io
- **GitHub Clone** – Custom VCS with branching & pull requests
- **SigmaGPT** – OpenAI powered chatbot
